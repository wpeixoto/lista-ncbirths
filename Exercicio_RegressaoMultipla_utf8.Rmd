...
Dentre todas as colunas, as seguintes podem ser escolhidas como variáveis dependentes:
...
Table: Colunas candidatas a variável dependente, segundo 
...
## Análises marginais e multivariadas {.tabset .tabset-fade } <!--.tabset-pills} -->
