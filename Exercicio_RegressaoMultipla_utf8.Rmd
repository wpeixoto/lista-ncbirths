...
boxplot(df1$Gained ~ df1$group, main="GAnho de peso por faixa etária", sub="Há pouca variação")

fit_gained1 = lm(Gained ~ ., data=NCbirths)
summary(fit_gained1)

# pairs(Gained ~ ., data=NCbirths)
pairs(Gained ~ Plural + MomAge + Weeks + BirthWeightOz, data=NCbirths)
...
plot(predict(fit_gained1), resid(fit_gained1),   # data=NCbirths,
     main="Valores ajustados versus resíduos")
