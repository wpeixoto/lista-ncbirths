...
Foi confirmado que, realmente, os registros marcados como `Low==Y` todos têm peso abaixo de 2500g, e os marcados com `Low==N` todos têm peso acima do informado na documentação. Por isso, esse campo pode seguramente ser ignorado nas regressões.
...
fit_gained = lm(Gained ~ ., data=NCbirths)
summary(fit_gained)
